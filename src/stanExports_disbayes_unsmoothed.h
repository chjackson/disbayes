...
namespace model_disbayes_unsmoothed_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_disbayes_unsmoothed");
    reader.add_event(3, 3, "include", "/include/trans_probs.stan");
    reader.add_event(3, 0, "start", "/include/trans_probs.stan");
    reader.add_event(78, 75, "end", "/include/trans_probs.stan");
    reader.add_event(78, 4, "restart", "model_disbayes_unsmoothed");
    reader.add_event(130, 54, "end", "model_disbayes_unsmoothed");
    return reader;
}
...
class model_disbayes_unsmoothed : public prob_grad {
private:
        int smooth;
        int nage;
        ...
        vector_d rem;
public:
    model_disbayes_unsmoothed(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_disbayes_unsmoothed_namespace::model_disbayes_unsmoothed";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("cf", "nage", nage);
        context__.validate_dims("parameter initialization", "cf", "vector_d", context__.to_vec(nage));
        Eigen::Matrix<double, Eigen::Dynamic, 1> cf(nage);
        size_t cf_j_1_max__ = nage;
        for (size_t j_1__ = 0; j_1__ < cf_j_1_max__; ++j_1__) {
            cf(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_lb_unconstrain(0, cf);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 94;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> cf;
            (void) cf;  // dummy to suppress unused var warning
            if (jacobian__)
                cf = in__.vector_lb_constrain(0, nage, lp__);
            else
                cf = in__.vector_lb_constrain(0, nage);
            ...
            lp_accum__.add(binomial_log<propto__>(inc_num, inc_denom, inc));
            current_statement_begin__ = 124;
            lp_accum__.add(binomial_log<propto__>(prev_num, prev_denom, prev));
            current_statement_begin__ = 125;
            for (int a = 1; a <= nage; ++a) {
                current_statement_begin__ = 126;
                lp_accum__.add(exponential_log<propto__>(get_base1(cf, a, "cf", 1), 1));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_disbayes_unsmoothed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> cf = in__.vector_lb_constrain(0, nage);
        size_t cf_j_1_max__ = nage;
        for (size_t j_1__ = 0; j_1__ < cf_j_1_max__; ++j_1__) {
    ...
    static std::string model_name() {
        return "model_disbayes_unsmoothed";
    }
...
typedef model_disbayes_unsmoothed_namespace::model_disbayes_unsmoothed stan_model;
#endif
