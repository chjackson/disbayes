...
#include "stanExports_disbayes_unsmoothed.h"

RCPP_MODULE(stan_fit4disbayes_unsmoothed_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_disbayes_unsmoothed")
