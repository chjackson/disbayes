...
library(progress)
library(tempdisagg)
relative_path_gbd <- "~/scratch/chronic/metahit_data/2017"
...
```{r}
library(readxl)
rem <- read_excel("~/work/chronic/cancerdata/Figure_10__Predicted_10-year_net-survival_using_the_hybrid_approach_for_men_and_women_(aged_15_to_99_years).xls", range="A7:C26", na=":") %>%
