...
To extract results for a specific variable and model, it is convenient to use standard "tidyverse" R functions, e.g. to get the median and interquartile range of case fatality for people aged between 60 and 65: 
